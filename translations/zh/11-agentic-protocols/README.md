...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-28T09:48:27+00:00",
...
**模型上下文协议 (MCP)** 是一种开放标准，为应用程序提供了一种标准化方式，向 LLM 提供上下文和工具。这使得 AI 代理能够以一致的方式连接到不同的数据源和工具，充当“通用适配器”。
