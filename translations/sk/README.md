...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T13:47:54+00:00",
  "source_file": "README.md",
  "language_code": "sk"
}
-->
# AI Agenty pre začiatočníkov - Kurz
...
## 11 lekcií, ktoré vás naučia všetko potrebné na začatie budovania AI agentov
...
Tento kurz obsahuje 11 lekcií, ktoré pokrývajú základy budovania AI agentov. Každá lekcia sa venuje vlastnej téme, takže môžete začať kdekoľvek!
...
Ak sa zaseknete alebo máte akékoľvek otázky ohľadom budovania AI agentov, pripojte sa k našej [Azure AI Foundry Community Discord](https://discord.gg/kzRShWzttr).

Ak máte spätnú väzbu k produktu alebo narazíte na chyby pri budovaní, navštívte [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum).
...
- [**NOVÉ** Protokol Model Context Protocol (MCP) pre začiatočníkov](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)
