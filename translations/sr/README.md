...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T22:42:32+00:00",
...
Курс подржава више језика. Погледајте [доступне језике овде](../..).  
...
### Упознајте друге учеснике, добијте одговоре на питања

Ако запнете или имате питања о изградњи АИ агената, придружите се нашем посвећеном Discord каналу у [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord).
...
Имате предлоге или сте пронашли правописне или програмске грешке? [Покрените проблем](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) или [Направите захтев за промену](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst).
...
|----------------------------------------------|-------------------------------------------------|------------------------------------------------------------|---------------------------------------------------------------------------------------|
| Увод у АИ агенте и њихове случајеве употребе  | [Линк](./01-intro-to-ai-agents/README.md)       | [Видео](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Образац за коришћење алата                   | [Линк](./04-tool-use/README.md)                 | [Видео](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Контекстуално инжењерство за АИ агенте       | Долази - 3. септембар                           |                                                            |                                                                                       |
| Управљање агентском меморијом              | Долази - 10. септембар                          |                                                            |                                                                                        |
| Евалуација AI агената                       | Долази - 17. септембар                          |                                                            |                                                                                        |
| Изградња агената за коришћење рачунара (CUA) | Долази - 24. септембар                          |                                                            |                                                                                        |
| Размештање скалабилних агената              | Долази - 25. септембар                          |                                                            |                                                                                        |
| Креирање локалних AI агената                | Долази - 2. октобар                             |                                                            |                                                                                        |
| Обезбеђивање AI агената                     | Долази - 9. октобар                             |                                                            |                                                                                        |
...
Када поднесете pull request, CLA бот ће аутоматски утврдити да ли треба да доставите
