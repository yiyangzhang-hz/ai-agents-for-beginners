...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T09:16:09+00:00",
...
Ако први пут радите са генеративним АИ моделима, погледајте наш курс [Генеративна АИ за Почетнике](https://aka.ms/genai-beginners), који укључује 21 лекцију о изградњи са GenAI.
...
| Агенти са РАГ стратегијом                    | [Линк](./05-agentic-rag/README.md)               | [Видео](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Коришћење протокола за агенте (MCP, A2A и NLWeb)| [Линк](./11-agentic-protocols/README.md)         | [Видео](https://youtu.be/X-Dh9R3Opn8)                      | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Контекстуално инжењерство за AI агенте       | [Линк](./12-context-engineering/README.md)         | [Видео](https://youtu.be/F5zqRV7gEag)                                 | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Управљање агентским памћењем                 | Долази - 11. септембар                             |                                                            |                                                                                        |
| Евалуација AI агената                        | Долази - 18. септембар                             |                                                            |                                                                                        |
| Изградња агената за коришћење рачунара (CUA)  | Долази - 25. септембар                             |                                                            |                                                                                        |
| Дистрибуција скалабилних агената             | Долази - 25. септембар                             |                                                            |                                                                                        |
...
- [Савладавање GitHub Copilot-а за парно програмирање са AI](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
и заправо дајете, права да користимо ваш допринос. За више детаља, посетите 
<https://cla.opensource.microsoft.com>.

Када пошаљете pull захтев, CLA бот ће аутоматски утврдити да ли треба да обезбедите
CLA и одговарајуће означити PR (нпр. статусна провера, коментар). Само пратите упутства
...
жигова или логотипа подлеже и мора пратити
[Microsoft-ове смернице за жигове и брендове](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Употреба Microsoft жигова или логотипа у измењеним верзијама овог пројекта не сме изазвати забуну или имплицирати Microsoft спонзорство.
