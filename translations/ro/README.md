...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-07T08:06:36+00:00",
...
**Dacă dorești să adaugi suport pentru alte limbi, lista limbilor disponibile este [aici](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Acest curs conține lecții care acoperă fundamentele construirii Agenților AI. Fiecare lecție tratează un subiect separat, așa că poți începe de unde dorești!
...
Nu uita să [adaugi o stea (🌟) acestui repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) și să [forkezi acest repo](https://github.com/microsoft/ai-agents-for-beginners/fork) pentru a rula codul.
...
Fiecare lecție din acest curs include exemple de cod, care pot fi găsite în folderul code_samples. Poți [forka acest repo](https://github.com/microsoft/ai-agents-for-beginners/fork) pentru a crea propria copie.
...
Pentru mai multe informații despre rularea codului din acest curs, accesează [Configurarea Cursului](./00-course-setup/README.md).

## 🙏 Vrei să ajuți?

Ai sugestii sau ai găsit greșeli de ortografie sau în cod? [Deschide o problemă](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) sau [Creează un pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst).

## 📂 Fiecare lecție include

- O lecție scrisă în README și un scurt videoclip  
...
| Gestionarea Memoriei Agenților               | Disponibil - 11 septembrie                         |                                                            |                                                                                        |
...
un CLA și va adăuga informațiile corespunzătoare la PR (de exemplu, verificarea stării, comentariu). Urmați pur și simplu instrucțiunile
...
[Directiva privind Mărcile Comerciale și Brandul Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
