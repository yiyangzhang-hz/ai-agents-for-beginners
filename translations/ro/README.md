...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-12T08:46:25+00:00",
...
Acest curs cuprinde 11 lecții care acoperă elementele de bază pentru construirea Agenților AI. Fiecare lecție tratează un subiect diferit, așa că poți începe de unde dorești!
...
Acest curs folosește, de asemenea, următoarele cadre și servicii AI Agent de la Microsoft:

- [Azure AI Agent Service](https://aka.ms/ai-agents-beginners/ai-agent-service)  
- [Semantic Kernel](https://aka.ms/ai-agents-beginners/semantic-kernel)  
- [AutoGen](https://aka.ms/ai-agents/autogen)

Pentru mai multe informații despre rularea codului pentru acest curs, consultă [Configurarea Cursului](./00-course-setup/README.md).
...
Dacă ai feedback despre produs sau întâmpini erori în timpul construirii, vizitează [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum).
...
- [**NOU** Model Context Protocol (MCP) Pentru Începători](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)
...
- [Învățare Automată pentru Începători](https://aka.ms/ml-beginners?WT.mc_id=academic-105485-koreyst)
- [Știința Datelor pentru Începători](https://aka.ms/datascience-beginners?WT.mc_id=academic-105485-koreyst)
- [Inteligență Artificială pentru Începători](https://aka.ms/ai-beginners?WT.mc_id=academic-105485-koreyst)
...
Mulțumiri lui [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) pentru contribuția cu exemple importante de cod care demonstrează Agentic RAG.

## Contribuții

Acest proiect primește cu plăcere contribuții și sugestii. Majoritatea contribuțiilor necesită să fii de acord cu un
Acord de Licență pentru Contribuitori (CLA) prin care declari că ai dreptul și chiar ne acorzi
