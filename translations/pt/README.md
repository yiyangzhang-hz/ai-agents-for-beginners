...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T08:12:57+00:00",
...
Este curso contém lições que abordam os fundamentos da criação de Agentes de IA. Cada lição cobre um tópico específico, então pode começar por onde preferir!

Há suporte multilíngue para este curso. Consulte os [idiomas disponíveis aqui](../..).

Se esta for a sua primeira vez a trabalhar com modelos de IA Generativa, confira o nosso curso [IA Generativa para Iniciantes](https://aka.ms/genai-beginners), que inclui 21 lições sobre como trabalhar com GenAI.
...
Se ficar preso ou tiver dúvidas sobre como criar Agentes de IA, junte-se ao nosso canal dedicado no Discord da [Comunidade Azure AI Foundry](https://aka.ms/ai-agents/discord).
...
- Exemplos de código em Python compatíveis com o Azure AI Foundry e Modelos do GitHub (Gratuito)  
- Links para recursos adicionais para continuar a sua aprendizagem  

## 🗃️ Lições

| **Lição**                                   | **Texto e Código**                                | **Vídeo**                                                  | **Aprendizagem Adicional**                                                             |
|---------------------------------------------|--------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
...
os direitos de usar a sua contribuição. Para mais detalhes, visite 
...
Este projeto pode conter marcas registadas ou logótipos de projetos, produtos ou serviços. O uso autorizado de marcas registadas ou logótipos da Microsoft está sujeito e deve seguir
