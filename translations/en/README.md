...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T11:58:30+00:00",
...
![Generative AI For Beginners](../../translated_images/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.en.png)

## 11 Lessons to teach you everything you need to know to start building AI Agents
...
This course consists of 11 lessons that cover the basics of building AI Agents. Each lesson focuses on a specific topic, so you can start wherever you prefer!

This course supports multiple languages. Check out the [available languages here](../..).

If this is your first time working with Generative AI models, take a look at our [Generative AI For Beginners](https://aka.ms/genai-beginners) course, which includes 21 lessons on working with GenAI.
...
For more details on running the code for this course, visit the [Course Setup](./00-course-setup/README.md).

## 🙏 Want to help?

Have suggestions or found spelling or code errors? [Raise an issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) or [Create a pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst).

If you’re stuck or have questions about building AI Agents, join our [Azure AI Foundry Community Discord](https://discord.gg/kzRShWzttr).

If you have product feedback or encounter errors while building, visit our [Azure AI Foundry Developer Forum](https://aka.ms/azureaifoundry/forum).
...
- Links to additional resources to continue learning  
