...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-12T08:27:04+00:00",
...
Ce cours comprend 11 leçons couvrant les bases de la création d’Agents IA. Chaque leçon traite d’un sujet spécifique, vous pouvez donc commencer où vous voulez !
...
Chaque leçon de ce cours inclut des exemples de code, que vous trouverez dans le dossier code_samples. Vous pouvez [forker ce repo](https://github.com/microsoft/ai-agents-for-beginners/fork) pour créer votre propre copie.
...
Si vous avez des retours produits ou des erreurs lors de la création, visitez notre [Forum développeurs Azure AI Foundry](https://aka.ms/azureaifoundry/forum)
...
| Comprendre les patterns de conception agentique | [Lien](./03-agentic-design-patterns/README.md)     | [Vidéo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pattern de conception d’utilisation d’outils | [Lien](./04-tool-use/README.md)                    | [Vidéo](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Pattern de conception de planification  | [Lien](./07-planning-design/README.md)             | [Vidéo](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pattern de conception multi-agent       | [Lien](./08-multi-agent/README.md)                 | [Vidéo](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pattern de conception métacognition     | [Lien](./09-metacognition/README.md)               | [Vidéo](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Lien](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
