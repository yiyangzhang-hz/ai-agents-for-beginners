...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T13:05:29+00:00",
...
## AI Ajanları oluşturmayı öğrenmek için ihtiyacınız olan her şeyi öğreten 11 Ders
...
**Ek dil desteği talep etmek isterseniz, desteklenen dillerin listesi [burada](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) bulunmaktadır.**
...
Eğer takılırsanız veya AI Ajanları oluşturma hakkında sorularınız varsa, [Azure AI Foundry Topluluk Discord](https://aka.ms/ai-agents/discord) kanalımıza katılabilirsiniz.

### İhtiyacınız Olanlar

Bu kurstaki her ders, kod örneklerini içerir ve bu örnekler `code_samples` klasöründe bulunabilir. Kendi kopyanızı oluşturmak için bu depoyu [çatallayabilirsiniz](https://github.com/microsoft/ai-agents-for-beginners/fork).
...
| **Ders**                                     | **Metin ve Kod**                                 | **Video**                                                  | **Ekstra Öğrenme**                                                                     |
|----------------------------------------------|-------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
...
| AI Ajanları için Bağlam Mühendisliği         | Yakında - 3 Eylül                               |                                                            |                                                                                        |
| Ajans Hafızasını Yönetme                     | Geliyor - 10 Eylül                                |                                                            |                                                                                        |
| AI Ajanslarını Değerlendirme                 | Geliyor - 17 Eylül                                |                                                            |                                                                                        |
| Bilgisayar Kullanım Ajansları (CUA) Oluşturma| Geliyor - 24 Eylül                                |                                                            |                                                                                        |
| Ölçeklenebilir Ajanslar Dağıtma              | Geliyor - 25 Eylül                                |                                                            |                                                                                        |
| Yerel AI Ajansları Oluşturma                 | Geliyor - 2 Ekim                                  |                                                            |                                                                                        |
| AI Ajanslarını Güvenceye Alma                | Geliyor - 9 Ekim                                  |                                                            |                                                                                        |

## 🎒 Diğer Kurslar

Ekibimiz başka kurslar da üretiyor! Göz atın:

- [**YENİ** Model Context Protocol (MCP) Başlangıç Seviyesi](https://github.com/microsoft/mcp-for-beginners?WT.mc_id=academic-105485-koreyst)
...
Agentic RAG'i gösteren önemli kod örnekleri katkılarından dolayı [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) teşekkür ederiz.

## Katkıda Bulunma

Bu proje katkılara ve önerilere açıktır. Çoğu katkı, bir Katkıda Bulunma Lisans Anlaşması (CLA) imzalamanızı gerektirir. Bu anlaşma, katkınızı kullanma hakkını bize verdiğinizi ve gerçekten bu hakkı verdiğinizi beyan eder. Detaylar için <https://cla.opensource.microsoft.com> adresini ziyaret edin.
