...
- **اسٹریمنگ اور جزوی نتائج**: عمل کے دوران حقیقی وقت کی پیش رفت کی اپ ڈیٹس
...
- حقیقی وقت کی پیش رفت کی اپ ڈیٹس
- عبوری نتائج

**MCP سپورٹ**: وسائل کی اپ ڈیٹ نوٹیفکیشنز اسٹریمنگ جزوی نتائج کو فعال کرتی ہیں، حالانکہ یہ JSON-RPC کے 1:1 درخواست/جواب ماڈل کے ساتھ تنازعات سے بچنے کے لیے محتاط ڈیزائن کی ضرورت ہوتی ہے۔

| خصوصیت                    | استعمال کا کیس                                                                                                                                                                       | MCP سپورٹ                                                                                |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| حقیقی وقت کی پیش رفت کی اپ ڈیٹس | صارف کوڈ بیس مائیگریشن کا کام درخواست کرتا ہے۔ ایجنٹ پیش رفت کو اسٹریمنگ کرتا ہے: "10% - ڈیپینڈنسیز کا تجزیہ کر رہا ہے... 25% - ٹائپ اسکرپٹ فائلز کو تبدیل کر رہا ہے... 50% - امپورٹس کو اپ ڈیٹ کر رہا ہے..."          | ✅ پیش رفت کی نوٹیفکیشنز                                                                  |
| جزوی نتائج            | "کتاب تیار کریں" کام جزوی نتائج کو اسٹریمنگ کرتا ہے، مثلاً، 1) کہانی کے آرک کا خاکہ، 2) بابوں کی فہرست، 3) ہر باب مکمل ہونے کے ساتھ۔ میزبان کسی بھی مرحلے پر معائنہ، منسوخ، یا ری ڈائریکٹ کر سکتا ہے۔ | ✅ نوٹیفکیشنز کو "توسیع" کیا جا سکتا ہے تاکہ جزوی نتائج شامل ہوں، PR 383، 776 پر تجاویز دیکھیں |

<div align="center" style="font-style: italic; font-size: 0.95em; margin-bottom: 0.5em;">
<strong>شکل 1:</strong> یہ ڈایاگرام دکھاتا ہے کہ MCP ایجنٹ طویل مدت تک چلنے والے کام کے دوران میزبان ایپلیکیشن کو حقیقی وقت کی پیش رفت کی اپ ڈیٹس اور جزوی نتائج کیسے اسٹریمنگ کرتا ہے، صارف کو عمل درآمد کی نگرانی کرنے کے قابل بناتا ہے۔
</div>
...
نوٹ کریں کہ ایک کمیونٹی تجویز (PR #975) موجود ہے جو ٹرانسپورٹ-اگناسٹک دوبارہ شروع ہونے والے اسٹریمز کو دریافت کرتی ہے۔

| خصوصیت      | استعمال کا کیس                                                                                                                                                   | MCP سپورٹ                                                                |
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| دوبارہ شروع کرنے کی صلاحیت | کلائنٹ طویل مدت تک چلنے والے کام کے دوران منقطع ہو جاتا ہے۔ دوبارہ جڑنے پر، سیشن دوبارہ شروع ہوتا ہے، چھوٹے ہوئے ایونٹس کو دوبارہ چلایا جاتا ہے، اور بغیر کسی رکاوٹ کے وہیں سے جاری رہتا ہے جہاں سے چھوڑا تھا۔ | ✅ StreamableHTTP ٹرانسپورٹ سیشن IDs، ایونٹ ری پلے، اور EventStore کے ساتھ |

<div align="center" style="font-style: italic; font-size: 0.95em; margin-bottom: 0.5em;">
<strong>شکل 2:</strong> یہ ڈایاگرام دکھاتا ہے کہ MCP کا StreamableHTTP ٹرانسپورٹ اور ایونٹ اسٹور کیسے ہموار سیشن دوبارہ شروع کرنے کو فعال کرتا ہے: اگر کلائنٹ منقطع ہو جائے، تو یہ دوبارہ جڑ سکتا ہے اور چھوٹے ہوئے ایونٹس کو دوبارہ چلا سکتا ہے، کام کو بغیر کسی پیش رفت کے نقصان کے جاری رکھ سکتا ہے۔
</div>
...
**MCP سپورٹ**: MCP اب ٹول کالز کے لیے ایک Resource لنک ریٹرن ٹائپ کی حمایت کرتا ہے۔ آج، ایک ممکنہ نمونہ یہ ہے کہ ایک ٹول کو ڈیزائن کیا جائے جو ایک وسیلہ بناتا ہے اور فوری طور پر ایک وسیلہ لنک واپس کرتا ہے۔ ٹول پس منظر میں کام کو جاری رکھ سکتا ہے اور وسیلہ کو اپ ڈیٹ کر سکتا ہے۔ اس کے بدلے میں، کلائنٹ اس وسیلہ کی حالت کو پول کرنے کا انتخاب کر سکتا ہے تاکہ جزوی یا مکمل نتائج حاصل کیے جا سکیں (اس بنیاد پر کہ سرور کون سی وسیلہ اپ ڈیٹس فراہم کرتا ہے) یا اپ ڈیٹ نوٹیفکیشنز کے لیے وسیلہ کو سبسکرائب کر سکتا ہے۔

یہاں ایک حد یہ ہے کہ وسائل کو پول کرنا یا اپ ڈیٹس کے لیے سبسکرائب کرنا وسائل کو استعمال کر سکتا ہے، جس کے پیمانے پر اثرات ہو سکتے ہیں۔ ایک کھلی کمیونٹی تجویز (بشمول #992) موجود ہے جو ویب ہکس یا ٹرگرز کو شامل کرنے کے امکان کو دریافت کرتی ہے جو سرور کلائنٹ/میزبان ایپلیکیشن کو اپ ڈیٹس کی اطلاع دینے کے لیے کال کر سکتا ہے۔

| خصوصیت    | استعمال کا کیس                                                                                                                                        | MCP سپورٹ                                                        |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| پائیداری | سرور ڈیٹا مائیگریشن کے کام کے دوران کریش ہو جاتا ہے۔ نتائج اور پیش رفت ری اسٹارٹ کے بعد بھی برقرار رہتی ہے، کلائنٹ حیثیت کو چیک کر سکتا ہے اور مستقل وسیلہ سے جاری رکھ سکتا ہے۔ | ✅ وسائل کے لنکس مستقل اسٹوریج اور حیثیت کی نوٹیفکیشنز کے ساتھ |

آج، ایک عام نمونہ یہ ہے کہ ایک ٹول کو ڈیزائن کیا جائے جو ایک وسیلہ بناتا ہے اور فوری طور پر ایک وسیلہ لنک واپس کرتا ہے۔ ٹول پس منظر میں کام کو جاری رکھ سکتا ہے، وسائل کی نوٹیفکیشنز جاری کر سکتا ہے جو پیش رفت کی اپ ڈیٹس کے طور پر کام کرتی ہیں یا جزوی نتائج شامل کرتی ہیں، اور ضرورت کے مطابق وسیلہ میں مواد کو اپ ڈیٹ کر سکتا ہے۔

<div align="center" style="font-style: italic; font-size: 0.95em; margin-bottom: 0.5em;">
<strong>شکل 3:</strong> یہ ڈایاگرام دکھاتا ہے کہ MCP ایجنٹس مستقل وسائل اور حیثیت کی نوٹیفکیشنز کا استعمال کیسے کرتے ہیں تاکہ طویل مدت تک چلنے والے کام سرور ری اسٹارٹس کے بعد بھی برقرار رہیں، کلائنٹس کو پیش رفت چیک کرنے اور ناکامیوں کے بعد بھی نتائج حاصل کرنے کی اجازت دیتے ہیں۔
</div>
...
| خصوصیت                 | استعمال کا کیس                                                                                                                                     | MCP سپورٹ                                           |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| کثیر موڑ تعاملات | ٹریول بکنگ ایجنٹ صارف سے قیمت کی تصدیق کی درخواست کرتا ہے، پھر AI سے ٹریول ڈیٹا کا خلاصہ کرنے کی درخواست کرتا ہے، اس سے پہلے کہ بکنگ کا لین دین مکمل کرے۔ | ✅ انسانی انپٹ کے لیے elicitation، AI انپٹ کے لیے sampling |

<div align="center" style="font-style: italic; font-size: 0.95em; margin-bottom: 0.5em;">
<strong>شکل 4:</strong> یہ ڈایاگرام دکھاتا ہے کہ MCP ایجنٹس وسطی عمل کے دوران انٹرایکٹو طور پر انسانی انپٹ حاصل کر سکتے ہیں یا پیچیدہ، کثیر موڑ ورک فلو جیسے تصدیقات اور متحرک فیصلہ سازی کی حمایت کرتے ہوئے AI کی مدد کی درخواست کر سکتے ہیں۔
</div>
...
- **ٹریول ایجنٹ** - قیمت کی تصدیق کے ذریعے ٹریول بکنگ سروس کی نقل کرتا ہے
...
#### اسٹریمنگ اور پیش رفت کی اپ ڈیٹس - حقیقی وقت کے کام کی حیثیت
...
**سرور نفاذ (ایجنٹ پیش رفت کی نوٹیفکیشنز بھیجتا ہے):**
...
Sampling ایجنٹس کو عمل درآمد کے دوران پیچیدہ فیصلوں یا مواد کی تخلیق کے لیے LLM کی مدد کی درخواست کرنے کی اجازت دیتا ہے۔ یہ ہائبرڈ انسانی-AI ورک فلو کو فعال کرتا ہے۔
...
دوبارہ شروع کرنے کی صلاحیت اس بات کو یقینی بناتی ہے کہ طویل مدت تک چلنے والے ایجنٹ کے کام کلائنٹ کے منقطع ہونے کے بعد بھی برقرار رہیں اور دوبارہ جڑنے پر بغیر کسی رکاوٹ کے جاری رہیں۔ یہ ایونٹ اسٹورز اور دوبارہ شروع کرنے والے ٹوکنز کے ذریعے نافذ کیا جاتا ہے۔
...
**کلائنٹ میٹا ڈیٹا دوبارہ شروع کرنے والے ٹوکن کے ساتھ (کلائنٹ محفوظ شدہ حالت کا استعمال کرتے ہوئے دوبارہ جڑتا ہے):**
...
میزبان ایپلیکیشن سیشن IDs اور دوبارہ شروع کرنے والے ٹوکنز کو مقامی طور پر برقرار رکھتی ہے، اسے موجودہ سیشنز سے دوبارہ جڑنے کے قابل بناتی ہے بغیر کسی پیش رفت یا حالت کے نقصان کے۔
...
- **`server/server.py`** - دوبارہ شروع ہونے والا MCP سرور، ٹریول اور ریسرچ ایجنٹس کے ساتھ جو elicitation، sampling، اور پیش رفت کی اپ ڈیٹس کا مظاہرہ کرتے ہیں
...
- **لچک اور دوبارہ کوششیں**: میزبان ناکامیوں کا انتظام کرتا ہے، دوبارہ کوشش کرنے کی منطق نافذ کرتا ہے، اور جب ای
