...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T20:57:35+00:00",
...
Не забравяйте да [добавите звезда (🌟) към това хранилище](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и да [разклоните това хранилище](https://github.com/microsoft/ai-agents-for-beginners/fork), за да изпълните кода.

### Срещнете се с други обучаващи се, задайте въпроси

Ако срещнете затруднения или имате въпроси относно създаването на AI агенти, присъединете се към нашия специален канал в Discord в [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord).

### Какво ви е необходимо

Всеки урок в този курс включва примери за код, които можете да намерите в папката `code_samples`. Можете да [разклоните това хранилище](https://github.com/microsoft/ai-agents-for-beginners/fork), за да създадете свое собствено копие.

Примерите за код в тези упражнения използват Azure AI Foundry и GitHub Model Catalogs за взаимодействие с езикови модели:

- [GitHub Модели](https://aka.ms/ai-agents-beginners/github-models) - Безплатно / Ограничено
...
- Примери за код на Python, поддържащи Azure AI Foundry и GitHub модели (безплатно)  
...
| Контекстно инженерство за AI агенти          | Очаквайте - 3 септември                         |                                                            |                                                                                       |
| Управление на агентна памет                  | Очаквайте - 10 септември                          |                                                            |                                                                                        |
| Оценяване на AI агенти                       | Очаквайте - 17 септември                          |                                                            |                                                                                        |
| Създаване на агенти за използване на компютър (CUA) | Очаквайте - 24 септември                          |                                                            |                                                                                        |
| Разгръщане на мащабируеми агенти             | Очаквайте - 25 септември                          |                                                            |                                                                                        |
| Създаване на локални AI агенти               | Очаквайте - 2 октомври                            |                                                            |                                                                                        |
| Осигуряване на сигурност за AI агенти        | Очаквайте - 9 октомври                            |                                                            |                                                                                        |
...
Този проект може да съдържа търговски марки или лога за проекти, продукти или услуги. Разрешеното използване на търговски марки или лога на Microsoft е предмет на и трябва да следва
...
Използването на търговски марки или лога на Microsoft в модифицирани версии на този проект не трябва да предизвиква объркване или да предполага спонсорство от Microsoft.
