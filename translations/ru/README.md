...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T12:21:04+00:00",
...
Этот курс состоит из 11 уроков, охватывающих основы создания AI агентов. Каждый урок посвящен отдельной теме, так что вы можете начать с любого места!
...
Не забудьте [поставить звезду (🌟) этому репозиторию](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и [сделать форк репозитория](https://github.com/microsoft/ai-agents-for-beginners/fork), чтобы запустить код.

### Общайтесь с другими учениками, задавайте вопросы

Если вы застряли или у вас есть вопросы о создании AI агентов, присоединяйтесь к нашему каналу в Discord в [Azure AI Foundry Community Discord](https://aka.ms/ai-agents/discord).

### Что вам понадобится

Каждый урок курса включает примеры кода, которые можно найти в папке code_samples. Вы можете [сделать форк репозитория](https://github.com/microsoft/ai-agents-for-beginners/fork), чтобы создать свою копию.
...
| Контекстная инженерия для AI агентов         | Скоро - 3 сентября                               |                                                            |                                                                                        |
| Управление агентной памятью                  | Доступно - 10 сентября                             |                                                            |                                                                                        |
| Оценка AI-агентов                            | Доступно - 17 сентября                             |                                                            |                                                                                        |
| Создание агентов для работы с компьютером (CUA) | Доступно - 24 сентября                             |                                                            |                                                                                        |
| Развертывание масштабируемых агентов          | Доступно - 25 сентября                             |                                                            |                                                                                        |
| Создание локальных AI-агентов                 | Доступно - 2 октября                               |                                                            |                                                                                        |
| Обеспечение безопасности AI-агентов           | Доступно - 9 октября                               |                                                            |                                                                                        |
