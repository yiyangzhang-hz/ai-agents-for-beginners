...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T13:21:01+00:00",
...
Давайте рассмотрим различные компоненты NLWeb, преимущества NLWeb и пример его работы на примере нашего приложения для путешествий.
