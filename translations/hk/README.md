...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-28T11:51:09+00:00",
...
![生成式AI入門](../../translated_images/repo-thumbnailv2.06f4a48036fde647f6ba4eb19f5651babe59bb30e972748afb349e47725d7601.hk.png)
...
這門課程包含11堂課，涵蓋建立AI代理的基礎知識。每堂課都有自己的主題，你可以從任何一堂課開始學習！

此課程支援多語言版本，請查看我們的[可用語言](../..)。

如果你是第一次使用生成式AI模型，請查看我們的[生成式AI入門課程](https://aka.ms/genai-beginners)，該課程包含21堂課，教你如何使用生成式AI。
...
此課程的每堂課都包含代碼範例，這些範例可以在code_samples文件夾中找到。你可以[分叉這個倉庫](https://github.com/microsoft/ai-agents-for-beginners/fork)來創建自己的副本。
...
感謝 [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) 提供重要的代碼範例，展示了代理式 RAG。
...
此項目可能包含項目、產品或服務的商標或標誌。授權使用 Microsoft 商標或標誌必須遵守並符合
