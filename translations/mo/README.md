...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T12:31:53+00:00",
...
本課程包含11堂課，涵蓋建立AI代理的基本知識。每堂課都有自己的主題，您可以從任何一堂課開始學習！
...
感謝 [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) 提供重要的代碼範例，展示了代理式 RAG 的應用。

## 貢獻

此專案歡迎貢獻和建議。大多數貢獻需要您同意一份貢獻者許可協議 (CLA)，聲明您有權並確實授予我們使用您貢獻的權利。詳細資訊請訪問 
