...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-29T13:27:43+00:00",
...
As seções a seguir mostram a implementação do lado do servidor para agentes e o tratamento do lado do cliente para cada capacidade:

#### Streaming e Atualizações de Progresso - Status de Tarefa em Tempo Real
...
**Implementação do Servidor (agente envia notificações de progresso):**
...
**Implementação do Cliente (host recebe atualizações de progresso):**
...
**Implementação do Servidor (agente solicita confirmação):**
...
**Implementação do Cliente (host fornece callback de eliciação):**
...
**Implementação do Servidor (agente solicita assistência de IA):**
...
**Implementação do Cliente (host fornece callback de amostragem):**
...
- **`server/event_store.py`** - Implementação de Event Store que habilita retomada de sessão e reentrega de mensagens
...
- **Gerenciamento de Estado de Tarefas**: Host rastreia progresso entre múltiplas tarefas de agentes concorrentes, lidando com dependências e sequenciamento
