...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-21T12:53:56+00:00",
...
![IA Generativa para Iniciantes](../../translated_images/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.br.png)

## 11 Lições ensinando tudo o que você precisa saber para começar a criar Agentes de IA
...
Este curso possui 11 lições que cobrem os fundamentos para criar Agentes de IA. Cada lição aborda um tópico específico, então comece por onde preferir!
...
Se você ficar preso ou tiver dúvidas sobre como criar Agentes de IA, junte-se ao nosso [Discord da Comunidade Azure AI Foundry](https://discord.gg/kzRShWzttr).

Se você tiver feedback sobre produtos ou encontrar erros durante a criação, visite nosso [Fórum de Desenvolvedores do Azure AI Foundry](https://aka.ms/azureaifoundry/forum).
...
| **Lição**                                | **Texto e Código**                                | **Vídeo**                                                  | **Aprendizado Extra**                                                                 |
|------------------------------------------|--------------------------------------------------|------------------------------------------------------------|---------------------------------------------------------------------------------------|
