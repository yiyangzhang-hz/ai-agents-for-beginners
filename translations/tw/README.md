...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-12T08:32:00+00:00",
...
本課程包含 11 節課，涵蓋打造 AI Agents 的基礎知識。每節課都有獨立主題，歡迎從任何一節開始學習！

本課程支援多語言，請參考我們的[可用語言列表](../..)。

如果你是第一次使用生成式 AI 模型，建議先參考我們的[Generative AI For Beginners](https://aka.ms/genai-beginners) 課程，內含 21 節課，專注於生成式 AI 的應用。
...
本課程每節課都包含程式碼範例，位於 code_samples 資料夾中。你可以[Fork 此專案](https://github.com/microsoft/ai-agents-for-beginners/fork)來建立自己的副本。

這些練習中的程式碼範例使用 Azure AI Foundry 和 GitHub Model Catalogs 來與語言模型互動：

- [Github Models](https://aka.ms/ai-agents-beginners/github-models) - 免費 / 有使用限制  
- [Azure AI Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - 需要 Azure 帳號

本課程還使用了微軟的以下 AI Agent 框架與服務：
...
如果你在打造 AI Agents 遇到困難或有任何問題，歡迎加入我們的[Azure AI Foundry 社群 Discord](https://discord.gg/kzRShWzttr)。
...
CLA，並適當標註 PR（例如狀態檢查、留言）。只要依照機器人
提供的指示操作即可。您在所有使用我們 CLA 的倉庫中只需執行一次此程序。
