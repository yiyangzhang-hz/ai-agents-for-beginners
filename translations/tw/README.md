...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-04T07:48:16+00:00",
...
這門課程包含了建立AI代理的基礎知識。每個課程都有自己的主題，你可以從任何地方開始學習！
...
此專案歡迎貢獻和建議。大多數貢獻需要您同意一份貢獻者許可協議（CLA），聲明您有權並確實授予我們使用您的貢獻的權利。詳細資訊請訪問 
...
[Microsoft的商標與品牌指南](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)。
